...
我在尋找重型 IDE 集成的替代品時發現了 [OpenCode](https://github.com/anomalyco/opencode)。它擁有 **126,600+ GitHub 星標**，而且仍在積極維護中，是一款具有內置遠程訪問的客戶端/伺服器架構的 AI 編程助手。吸引我注意力的是：**OpenCode 具有內置遠程訪問的客戶端/伺服器架構**。
...
- ✅ 對異步、長期運行的編程任務效果很好
- ✅ 可通過 MCP 和自定義集成進行擴展
- ✅ 開源且持續積極維護，擁有 126,600+ GitHub 星標
...
- **GitHub 存儲庫**：[github.com/anomalyco/opencode](https://github.com/anomalyco/opencode)（126,600+ 星標，持續積極維護）
