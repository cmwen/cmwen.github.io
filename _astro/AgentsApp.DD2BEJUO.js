...
- Decision implications`}];function k({providers:t,selectedProvider:i,onProviderChange:s}){return e.jsxs("div",{className:"mb-6",children:[e.jsx("label",{htmlFor:"provider-select",className:"block text-sm font-medium text-skin-base mb-2",children:"Target LLM"}),e.jsx("select",{id:"provider-select",value:i.id,onChange:r=>{const o=t.find(p=>p.id===r.target.value);o&&s(o)},className:"block w-full max-w-xs rounded-md border border-skin-line bg-skin-fill px-3 py-2 text-skin-base focus:border-skin-accent focus:outline-none focus:ring-1 focus:ring-skin-accent",children:t.map(r=>e.jsx("option",{value:r.id,children:r.name},r.id))}),e.jsx("p",{className:"mt-1 text-sm text-skin-base opacity-70",children:i.supportsDirectPrompt?"Supports direct prompt injection":"Prompt will be copied to clipboard"})]})}function w({agents:t,onFilteredAgentsChange:i}){const[s,r]=l.useState(""),[o,p]=l.useState(""),h=f.useMemo(()=>{const a=t.flatMap(d=>d.tags);return[...new Set(a)].sort()},[t]);return f.useEffect(()=>{let a=t;if(s){const d=s.toLowerCase();a=a.filter(m=>m.name.toLowerCase().includes(d)||m.description.toLowerCase().includes(d)||m.tags.some(g=>g.toLowerCase().includes(d)))}o&&(a=a.filter(d=>d.tags.includes(o))),i(a)},[s,o,t,i]),e.jsxs("div",{className:"mb-6 space-y-4",children:[e.jsxs("div",{className:"flex flex-col gap-4 sm:flex-row",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("label",{htmlFor:"agent-search",className:"sr-only",children:"Search agents"}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{id:"agent-search",type:"text",value:s,onChange:a=>r(a.target.value),placeholder:"Search agents by name, description, or tags...",className:"w-full rounded-md border border-skin-line bg-skin-fill px-4 py-2 pl-10 text-skin-base focus:border-skin-accent focus:outline-none focus:ring-1 focus:ring-skin-accent"}),e.jsx("svg",{className:"absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-skin-base opacity-50",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})})]})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"tag-filter",className:"sr-only",children:"Filter by tag"}),e.jsxs("select",{id:"tag-filter",value:o,onChange:a=>p(a.target.value),className:"rounded-md border border-skin-line bg-skin-fill px-3 py-2 text-skin-base focus:border-skin-accent focus:outline-none focus:ring-1 focus:ring-skin-accent",children:[e.jsx("option",{value:"",children:"All categories"}),h.map(a=>e.jsx("option",{value:a,children:a},a))]})]})]}),(s||o)&&e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("span",{className:"text-sm text-skin-base opacity-70",children:"Active filters:"}),s&&e.jsxs("span",{className:"inline-flex items-center gap-1 rounded-full bg-skin-accent px-3 py-1 text-xs text-skin-inverted",children:['Search: "',s,'"',e.jsx("button",{onClick:()=>r(""),className:"hover:bg-opacity-80","aria-label":"Clear search",children:"×"})]}),o&&e.jsxs("span",{className:"inline-flex items-center gap-1 rounded-full bg-skin-accent px-3 py-1 text-xs text-skin-inverted",children:["Tag: ",o,e.jsx("button",{onClick:()=>p(""),className:"hover:bg-opacity-80","aria-label":"Clear tag filter",children:"×"})]})]})]})}function j({agent:t,onClick:i}){return e.jsxs("div",{className:"cursor-pointer rounded-lg border border-skin-line bg-skin-card p-4 transition-colors hover:border-skin-accent hover:bg-skin-card-muted",onClick:()=>i(t),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),i(t))},tabIndex:0,role:"button","aria-label":`Open ${t.name} agent details`,children:[e.jsx("h3",{className:"font-semibold text-skin-base",children:t.name}),e.jsx("p",{className:"mt-2 text-sm text-skin-base opacity-80 line-clamp-2",children:t.description}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-2",children:[t.tags.slice(0,3).map(s=>e.jsx("span",{className:"inline-block rounded bg-skin-accent px-2 py-1 text-xs text-skin-inverted",children:s},s)),t.tags.length>3&&e.jsxs("span",{className:"inline-block rounded border border-skin-line px-2 py-1 text-xs text-skin-base",children:["+",t.tags.length-3," more"]})]})]})}function S({agent:t,provider:i,isOpen:s,onClose:r,onLaunch:o}){const[p,h]=l.useState(""),[a,d]=l.useState({});l.useEffect(()=>{if(t){const n=t.promptTemplate.match(/\{\{(\w+)\}\}/g),c={};n&&n.forEach(u=>{const b=u.slice(2,-2);c[b]=""}),d(c),h(t.promptTemplate)}},[t]);const m=f.useMemo(()=>{let n=p;return Object.entries(a).forEach(([c,u])=>{n=n.replace(new RegExp(`\\{\\{${c}\\}\\}`,"g"),u)}),n},[p,a]),g=async()=>{try{await navigator.clipboard.writeText(m)}catch(n){console.error("Failed to copy to clipboard:",n)}};return!s||!t?null:e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4",children:e.jsxs("div",{className:"max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-lg bg-skin-fill border border-skin-line",children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-skin-line p-6",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-semibold text-skin-base",children:t.name}),e.jsx("p",{className:"text-sm text-skin-base opacity-80",children:t.description})]}),e.jsx("button",{onClick:r,className:"rounded p-2 text-skin-base hover:bg-skin-card","aria-label":"Close agent details",children:e.jsx("svg",{className:"h-6 w-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})})]}),e.jsxs("div",{className:"p-6",children:[e.jsx("div",{className:"mb-4",children:e.jsx("div",{className:"flex flex-wrap gap-2",children:t.tags.map(n=>e.jsx("span",{className:"inline-block rounded bg-skin-accent px-2 py-1 text-xs text-skin-inverted",children:n},n))})}),Object.keys(a).length>0&&e.jsxs("div",{className:"mb-4",children:[e.jsx("h3",{className:"mb-2 text-sm font-medium text-skin-base",children:"Variables"}),e.jsx("div",{className:"space-y-2",children:Object.entries(a).map(([n,c])=>e.jsxs("div",{children:[e.jsx("label",{htmlFor:`var-${n}`,className:"block text-sm text-skin-base",children:n}),e.jsx("input",{id:`var-${n}`,type:"text",value:c,onChange:u=>d(b=>({...b,[n]:u.target.value})),className:"mt-1 block w-full rounded border border-skin-line bg-skin-fill px-3 py-2 text-skin-base focus:border-skin-accent focus:outline-none focus:ring-1 focus:ring-skin-accent",placeholder:`Enter ${n}...`})]},n))})]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("h3",{className:"mb-2 text-sm font-medium text-skin-base",children:"Prompt Template"}),e.jsx("textarea",{value:p,onChange:n=>h(n.target.value),className:"h-40 w-full rounded border border-skin-line bg-skin-fill p-3 text-sm text-skin-base focus:border-skin-accent focus:outline-none focus:ring-1 focus:ring-skin-accent",placeholder:"Edit your prompt here..."})]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("h3",{className:"mb-2 text-sm font-medium text-skin-base",children:"Final Prompt"}),e.jsx("div",{className:"max-h-32 overflow-y-auto rounded border border-skin-line bg-skin-card p-3 text-sm text-skin-base",children:e.jsx("pre",{className:"whitespace-pre-wrap",children:m})})]}),e.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row",children:[e.jsx("button",{onClick:()=>o(m),className:"rounded bg-skin-accent px-4 py-2 text-skin-inverted hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-skin-accent focus:ring-offset-2",children:i.supportsDirectPrompt?`Open in ${i.name}`:`Open ${i.name} & Copy Prompt`}),e.jsx("button",{onClick:g,className:"rounded border border-skin-line px-4 py-2 text-skin-base hover:bg-skin-card focus:outline-none focus:ring-2 focus:ring-skin-accent focus:ring-offset-2",children:"Copy Prompt"})]}),e.jsxs("div",{className:"mt-4 text-xs text-skin-base opacity-60",children:["Target: ",i.name,i.supportsDirectPrompt?" (supports direct prompt injection)":" (prompt will be copied to clipboard)"]})]})]})})}const v="agents.selectedProvider";function P(t){if(typeof window>"u")return t[0];try{const i=localStorage.getItem(v);if(i){const s=JSON.parse(i),r=t.find(o=>o.id===s);if(r)return r}}catch(i){console.error("Error reading provider from localStorage:",i)}return t[0]}function N(t){if(!(typeof window>"u"))try{localStorage.setItem(v,JSON.stringify(t.id))}catch(i){console.error("Error saving provider to localStorage:",i)}}function C(t,i){if(!t.supportsDirectPrompt)return t.webUrl;const s=encodeURIComponent(i);switch(t.id){case"openai_chatgpt":return`${t.webUrl.endsWith("/")?t.webUrl:t.webUrl+"/"}?model=gpt-4&prompt=${s}`;case"microsoft_copilot":return`${t.webUrl}?q=${s}`;case"perplexity":return`${t.webUrl}search?q=${s}`;default:return t.webUrl}}async function T(t,i){const s=C(t,i);if(t.supportsDirectPrompt)window.open(s,"_blank","noopener,noreferrer");else try{await navigator.clipboard.writeText(i),window.open(t.webUrl,"_blank","noopener,noreferrer"),console.log("Prompt copied to clipboard")}catch(r){console.error("Failed to copy prompt to clipboard:",r),window.open(t.webUrl,"_blank","noopener,noreferrer")}}function D(){const[t,i]=l.useState(()=>P(x)),[s,r]=l.useState(y),[o,p]=l.useState(null),[h,a]=l.useState(!1),d=l.useCallback(c=>{i(c),N(c)},[]),m=l.useCallback(c=>{p(c),a(!0)},[]),g=l.useCallback(()=>{a(!1),p(null)},[]),n=l.useCallback(async c=>{try{await T(t,c),a(!1)}catch(u){console.error("Failed to launch provider:",u)}},[t]);return e.jsxs("div",{className:"mx-auto max-w-4xl",children:[e.jsx(k,{providers:x,selectedProvider:t,onProviderChange:d}),e.jsx(w,{agents:y,onFilteredAgentsChange:r}),e.jsx("div",{className:"grid gap-4 sm:grid-cols-2 lg:grid-cols-3",children:s.map(c=>e.jsx(j,{agent:c,onClick:m},c.id))}),s.length===0&&e.jsxs("div",{className:"py-12 text-center",children:[e.jsx("svg",{className:"mx-auto h-12 w-12 text-skin-base opacity-50",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9.172 16.172a4 4 0 015.656 0M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"})}),e.jsx("h3",{className:"mt-4 text-lg font-medium text-skin-base",children:"No agents found"}),e.jsx("p",{className:"mt-2 text-skin-base opacity-70",children:"Try adjusting your search or filter criteria."})]}),e.jsx(S,{agent:o,provider:t,isOpen:h,onClose:g,onLaunch:n})]})}export{D as default};
